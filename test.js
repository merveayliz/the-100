// 1. SORU HAVUZU (Kitap Karakteri ve Diğerleri İçin Örnek Sorular Eklendi)
const sorular = {
    kitap_bilgi: [
...
function testiHazirla(tur) {
    ...
    // Puanları her test başında sıfırla
...
function soruyuGoster() {
    ...
    // --- BUTON KONTROLÜ (BURAYI DÜZELTTİK) ---
    // Eğer son sorudaysak Analiz butonunu göster, değilse Sonraki butonunu göster
...
// 2. SONUÇ EKRANI FONKSİYONU (GÖRSEL EKLENMİŞ HALİ)
function sonucuHesapla() {
    ...
    if (secilenTur.includes("bilgi")) {
        ...
        finalAciklama = puanlar.dogru >= 5 ? "Gerçek bir hayatta kalan!" : "Radyasyon seni bitirdi...";
        karakterResmi = "img/radyasyon.jpg"; // Bilgi testleri için genel bir görsel
    } else {
        let enYuksekSkor = -1;
        let kazanan = "";
        ...
        finalAciklama = "The 100 dünyasındaki yansımanı buldun.";
        // Karakterin ismine göre klasördeki resmi çekiyoruz
        karakterResmi = `img/${kazanan}.jpg`; 
    }

    // Modal İçeriğini Resimli Olarak Güncelliyoruz
    icerik.innerHTML = `
